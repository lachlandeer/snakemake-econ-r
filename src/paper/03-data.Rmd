...
In progress
```{r fig-sub, echo = FALSE, fig.cap = 'Convergence Plots', fig.subcap = c('Unconditional Convergence', 'Conditonal Convergence', 'Conditonal Convergence - Augmented Model'), fig.show = "hold", out.width='.75\\linewidth', fig.asp = 1, fig.ncol = 1}
